...
```{r}
setwd("~")
data <- read.csv("/Users/rsigalov/desktop/CRSP_data.csv", sep = ";")
colnames(data)
```
...
Here I will show you how to transform your variables to perform log-linear, linear-log, log-log, power and other regressions. 
